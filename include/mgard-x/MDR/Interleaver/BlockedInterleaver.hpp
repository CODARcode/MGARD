...
public:
  ...
  void reposition(T const *buffer, const std::vector<uint32_t> &dims,
    ...
    if (n1_nodal * n2_nodal * n3_nodal == 0) {
      ...
      buffer_pos += reposition_data_3d_blocked(
          buffer_pos, n1_nodal, n2_nodal, n3_coeff, dim0_offset, dim1_offset,
          block_size, nodal_nodal_coeff_pos);
      buffer_pos += reposition_data_3d_blocked(
          buffer_pos, n1_nodal, n2_coeff, n3_nodal, dim0_offset, dim1_offset,
          block_size, nodal_coeff_nodal_pos);
      buffer_pos += reposition_data_3d_blocked(
          buffer_pos, n1_nodal, n2_coeff, n3_coeff, dim0_offset, dim1_offset,
          block_size, nodal_coeff_coeff_pos);
      buffer_pos += reposition_data_3d_blocked(
          buffer_pos, n1_coeff, n2_nodal, n3_nodal, dim0_offset, dim1_offset,
          block_size, coeff_nodal_nodal_pos);
      buffer_pos += reposition_data_3d_blocked(
          buffer_pos, n1_coeff, n2_nodal, n3_coeff, dim0_offset, dim1_offset,
          block_size, coeff_nodal_coeff_pos);
      buffer_pos += reposition_data_3d_blocked(
          buffer_pos, n1_coeff, n2_coeff, n3_nodal, dim0_offset, dim1_offset,
          block_size, coeff_coeff_nodal_pos);
      buffer_pos += reposition_data_3d_blocked(
          buffer_pos, n1_coeff, n2_coeff, n3_coeff, dim0_offset, dim1_offset,
          block_size, coeff_coeff_coeff_pos);
    }
  }
