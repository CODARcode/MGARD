...
namespace MDR {
    ...
    public:
        ...
        std::vector<std::vector<const uint8_t*>> retrieve_level_components(const std::vector<std::vector<SIZE>>& level_sizes, const std::vector<SIZE>& retrieve_sizes, const std::vector<uint8_t>& prev_level_num_bitplanes, const std::vector<uint8_t>& level_num_bitplanes){
    ...
    private:
        std::vector<std::vector<const uint8_t*>> interleave_level_components(const std::vector<std::vector<SIZE>>& level_sizes, const std::vector<uint8_t>& prev_level_num_bitplanes, const std::vector<uint8_t>& level_num_bitplanes){
