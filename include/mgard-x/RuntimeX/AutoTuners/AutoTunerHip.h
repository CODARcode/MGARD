...
#ifndef MGARD_X_AUTOTUNER_HIP_H
#define MGARD_X_AUTOTUNER_HIP_H

namespace mgard_x {

template <> class KernelConfigs<HIP> {
public:
  MGARDX_CONT
  KernelConfigs(){};
};

template <> class AutoTuningTable<HIP> {
public:
  MGARDX_CONT
  AutoTuningTable() {
...
template <> class AutoTuner<HIP> {
public:
  MGARDX_CONT
  AutoTuner(){};

  static KernelConfigs<HIP> kernelConfigs;
  static AutoTuningTable<HIP> autoTuningTable;
