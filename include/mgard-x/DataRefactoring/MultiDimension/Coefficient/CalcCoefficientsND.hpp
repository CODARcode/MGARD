...
void CalcCoefficientsND(Hierarchy<D, T, DeviceType> &hierarchy,
  ...
  // PrintSubarray("prev::shape", shape);
  // PrintSubarray("prev::shape_c", shape_c);
  ...
  // PrintSubarray("curr::shape", shape);
  // PrintSubarray("curr::shape_c", shape_c);
  ...
  // PrintSubarray("prev::unprocessed_dims", unprocessed_dims);
  unprocessed_dims = hierarchy.unprocessed(unprocessed_idx, unprocessed_n);
  // PrintSubarray("curr::unprocessed_dims", unprocessed_dims);
  // curr_dims[0] = 0;
  // curr_dims[1] = 1;
  // curr_dims[2] = 2;
  // printf("prev_dims: %u %u %u\n", curr_dims[0], curr_dims[1], curr_dims[2]);
