...
#include "GridProcessingKernel3DWithErrorCollection.hpp"

#ifndef MGARD_X_DATA_REFACTORING_CALC_COEFFICIENTS_3D_WITH_ERROR_COLLECTION
#define MGARD_X_DATA_REFACTORING_CALC_COEFFICIENTS_3D_WITH_ERROR_COLLECTION
...
void CalcCoefficients3DWithErrorCollection(Hierarchy<D, T, DeviceType> &hierarchy,
  ...
  GpkReo3DWithErrorCollection<D, T, DeviceType>().Execute(
      l, hierarchy.dofs[2][l], hierarchy.dofs[1][l], hierarchy.dofs[0][l],
      ...
      max_abs_coefficient, max_abs_coefficient_finer, queue_idx);
