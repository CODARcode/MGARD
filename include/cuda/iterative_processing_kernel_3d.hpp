...
__global__ void _ipk_1_3d(int nr, int nc, int nf_c, T *am, T *bm, T *dist_f,
...
void ipk_1_3d_adaptive_launcher(mgard_cuda_handle<T, D> &handle, int nr, int nc,
...
template <typename T, int D, int R, int C, int F, int G>
void ipk_2_3d_adaptive_launcher(mgard_cuda_handle<T, D> &handle, int nr,
                                int nc_c, int nf_c, T *am, T *bm, T *ddist_c,
...
template <typename T, int D, int R, int C, int F, int G>
void ipk_3_3d_adaptive_launcher(mgard_cuda_handle<T, D> &handle, int nr_c,
                                int nc_c, int nf_c, T *am, T *bm, T *ddist_r,
                                T *dv, int lddv1, int lddv2, int queue_idx) {
