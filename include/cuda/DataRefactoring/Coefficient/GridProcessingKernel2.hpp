...
public:
  ...
  GenTask(SubArray<1, SIZE, DeviceType> shape, SubArray<1, SIZE, DeviceType> shape_c, SIZE *ldvs, SIZE *ldws, 
          DIM unprocessed_n, SubArray<1, DIM, DeviceType> unprocessed_dims,
          DIM curr_dim_r, DIM curr_dim_c, DIM curr_dim_f,
          SubArray<1, T, DeviceType> ratio_r, 
          SubArray<1, T, DeviceType> ratio_c, 
  ...
  MGARDm_CONT
  void Execute(SubArray<1, SIZE, DeviceType> shape, SubArray<1, SIZE, DeviceType> shape_c, SIZE *ldvs, SIZE *ldws, 
            DIM unprocessed_n, SubArray<1, DIM, DeviceType> unprocessed_dims,
            DIM curr_dim_r, DIM curr_dim_c, DIM curr_dim_f,
            SubArray<1, T, DeviceType> ratio_r, 
            SubArray<1, T, DeviceType> ratio_c, 
    ...
    if (config == CONFIG || AutoTuner<DeviceType>::ProfileKernels) { \
      ...
      TaskType task = GenTask<R, C, F>(\
                                shape, shape_c, ldvs, ldws, unprocessed_n, unprocessed_dims,\
                                curr_dim_r, curr_dim_c, curr_dim_f,\
                                ratio_r, ratio_c, ratio_f,\
                                v, w, \
                                wf, wc, wr, \
