...
__host__ inline size_t get_idx(thrust::device_vector<int> lds, thrust::device_vector<int> idx) {
...
__host__ inline thrust::device_vector<int> gen_idx(int D, int curr_dim_r, int curr_dim_c, int curr_dim_f,
