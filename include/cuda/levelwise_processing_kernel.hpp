...
void lwpk(mgard_cuda_handle<T, D> &handle, thrust::device_vector<int> shape,
          T *dv, thrust::device_vector<int> ldvs, T *dwork,
          thrust::device_vector<int> ldws, int queue_idx) {
...
template <typename T, int D, int R, int C, int F, int OP>
void lwpk_adaptive_launcher(mgard_cuda_handle<T, D> &handle, int *shape_h,
                            int *shape_d, T *dv, int *ldvs, T *dwork, int *ldws,
                            int queue_idx) {
...
template <typename T, int D, int OP>
void lwpk(mgard_cuda_handle<T, D> &handle, int *shape_h, int *shape_d, T *dv,
          int *ldvs, T *dwork, int *ldws, int queue_idx) {
#define COPYLEVEL(R, C, F)                                                     \
  {                                                                            \
