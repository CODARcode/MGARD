...
template <typename T, int D, int R, int C, int F, int G>
void ipk_1_adaptive_launcher(mgard_cuda_handle<T, D> &handle, int *shape_h,
...
template <typename T, int D, int R, int C, int F, int G>
void ipk_2_adaptive_launcher(mgard_cuda_handle<T, D> &handle, int *shape_h,
                             int *shape_c_h, int *shape_d, int *shape_c_d,
                             int *ldvs, int *ldws, int processed_n,
                             int *processed_dims_h, int *processed_dims_d,
                             int curr_dim_r, int curr_dim_c, int curr_dim_f,
                             T *am, T *bm, T *ddist_c, T *dv, int lddv1,
                             int lddv2, int queue_idx) {
  int nr = shape_h[curr_dim_r];
...
template <typename T, int D, int R, int C, int F, int G>
void ipk_3_adaptive_launcher(mgard_cuda_handle<T, D> &handle, int *shape_h,
                             int *shape_c_h, int *shape_d, int *shape_c_d,
                             int *ldvs, int *ldws, int processed_n,
                             int *processed_dims_h, int *processed_dims_d,
                             int curr_dim_r, int curr_dim_c, int curr_dim_f,
                             T *am, T *bm, T *ddist_r, T *dv, int lddv1,
                             int lddv2, int queue_idx) {
