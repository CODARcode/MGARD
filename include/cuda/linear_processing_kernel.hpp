...
template <typename T, int D, int R, int C, int F>
void lpk_reo_1_adaptive_launcher(mgard_cuda_handle<T, D> &handle, int *shape_h,
...
template <typename T, int D>
void lpk_reo_1(mgard_cuda_handle<T, D> &handle, int *shape_h, int *shape_c_h,
               int *shape_d, int *shape_c_d, int *ldvs, int *ldws,
               int processed_n, int *processed_dims_h, int *processed_dims_d,
               int curr_dim_r, int curr_dim_c, int curr_dim_f, T *ddist_f,
               T *dratio_f, T *dv1, int lddv11, int lddv12, T *dv2, int lddv21,
...
template <typename T, int D, int R, int C, int F>
void lpk_reo_2_adaptive_launcher(mgard_cuda_handle<T, D> &handle, int *shape_h,
                                 int *shape_c_h, int *shape_d, int *shape_c_d,
                                 int *ldvs, int *ldws, int processed_n,
                                 int *processed_dims_h, int *processed_dims_d,
                                 int curr_dim_r, int curr_dim_c, int curr_dim_f,
...
template <typename T, int D>
void lpk_reo_2(mgard_cuda_handle<T, D> &handle, int *shape_h, int *shape_c_h,
               int *shape_d, int *shape_c_d, int *ldvs, int *ldws,
               int processed_n, int *processed_dims_h, int *processed_dims_d,
               int curr_dim_r, int curr_dim_c, int curr_dim_f, T *ddist_c,
...
template <typename T, int D, int R, int C, int F>
void lpk_reo_3_adaptive_launcher(mgard_cuda_handle<T, D> &handle, int *shape_h,
                                 int *shape_c_h, int *shape_d, int *shape_c_d,
                                 int *ldvs, int *ldws, int processed_n,
                                 int *processed_dims_h, int *processed_dims_d,
                                 int curr_dim_r, int curr_dim_c, int curr_dim_f,
...
template <typename T, int D>
void lpk_reo_3(mgard_cuda_handle<T, D> &handle, int *shape_h, int *shape_c_h,
               int *shape_d, int *shape_c_d, int *ldvs, int *ldws,
               int processed_n, int *processed_dims_h, int *processed_dims_d,
               int curr_dim_r, int curr_dim_c, int curr_dim_f, T *ddist_r,
