...
__global__ void _lpk_reo_1( int * shape, int * shape_c,
                            int * ldvs, int * ldws,
  ...
  int bidx = blockIdx.x;
  int firstD;
  if (nf_c % 2 == 1) { firstD = div_roundup(nf_c, blockDim.x); }
  else { firstD = div_roundup(nf_c, blockDim.x); }
  ...
  for (int d = 0; d < D; d++) {
    if (d != curr_dim_r && d != curr_dim_c && d != curr_dim_f) {
      ...
      idx[d] = bidx % t;
      bidx /= t;
      if (idx[d] >= shape_c_sm[d]) zero_other = false;
    }
  }  
  ...
  if (D < 3) { nr = 1; zero_r = 1; }
  if (D < 2) { nc = 1; zero_c = 1; }
...
template <typename T, int D, int R, int C, int F>
void lpk_reo_1_adaptive_launcher(mgard_cuda_handle<T, D> &handle, 
...
#define LPK(R, C, F) { lpk_reo_1_adaptive_launcher<T, D, R, C, F>(handle,\
...
#define LPK(R, C, F) { lpk_reo_1_adaptive_launcher<T, D, R, C, F>(handle,\
                               shape_h, shape_c_h, shape_d, shape_c_d,\
                               ldvs, ldws,\
...
template <typename T, int D, int R, int C, int F>
__global__ void _lpk_reo_2( int * shape, int * shape_c,
                            int * ldvs, int * ldws,
                            int processed_n, int * processed_dims, 
                            int curr_dim_r, int curr_dim_c, int curr_dim_f, 
...
template <typename T, int D, int R, int C, int F>
void lpk_reo_2_adaptive_launcher(mgard_cuda_handle<T, D> &handle, 
                                 thrust::device_vector<int> shape, 
                                 thrust::device_vector<int> shape_c, 
                                 thrust::device_vector<int> ldvs, 
                                 thrust::device_vector<int> ldws,
...
#define LPK(R, C, F) {lpk_reo_2_adaptive_launcher<T, D, R, C, F>(handle,\
                               shape, shape_c, ldvs, ldws, processed_dims,\
                               curr_dim_r, curr_dim_c, curr_dim_f,\
                               ddist_c, dratio_c,\
                               dv1, lddv11, lddv12,\
...
template <typename T, int D, int R, int C, int F>
__global__ void _lpk_reo_3( int * shape, int * shape_c,
                            int * ldvs, int * ldws,
                            int processed_n, int * processed_dims, 
                            int curr_dim_r, int curr_dim_c, int curr_dim_f, 
...
template <typename T, int D, int R, int C, int F>
void lpk_reo_3_adaptive_launcher(mgard_cuda_handle<T, D> &handle, 
                                 thrust::device_vector<int> shape, 
                                 thrust::device_vector<int> shape_c, 
                                 thrust::device_vector<int> ldvs, 
                                 thrust::device_vector<int> ldws,
...
#define LPK(R, C, F) {lpk_reo_3_adaptive_launcher<T, D, R, C, F>(handle,\
                               shape, shape_c, ldvs, ldws, processed_dims,\
                               curr_dim_r, curr_dim_c, curr_dim_f,\
                               ddist_r, dratio_r,\
                               dv1, lddv11, lddv12,\
