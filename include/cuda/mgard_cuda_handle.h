...
template <typename T, int D> struct mgard_cuda_handle {
  ...
  mgard_cuda_handle(std::vector<size_t> shape, std::vector<T*> coords, mgard_cuda_config config);
  ...
  T ***local_am_row_l, ***local_bm_row_l, ***local_am_col_l, ***local_bm_col_l, ***local_am_fib_l, ***local_bm_fib_l;
...
private:
  ...
  void init(std::vector<size_t> shape, std::vector<T*> coords, mgard_cuda_config config);
