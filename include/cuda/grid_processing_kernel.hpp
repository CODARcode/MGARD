...
void gpk_reo_adaptive_launcher(
    mgard_cuda_handle<T, D_GLOBAL> &handle, thrust::device_vector<int> shape,
...
void gpk_reo_adaptive_launcher(
    ...
    int *unprocessed_dims, int curr_dim_r, int curr_dim_c, int curr_dim_f,
    T *dratio_r, T *dratio_c, T *dratio_f, T *dv, int lddv1, int lddv2, T *dw,
    int lddw1, int lddw2, T *dwf, int lddwf1, int lddwf2, T *dwc, int lddwc1,
    int lddwc2, T *dwr, int lddwr1, int lddwr2, T *dwcf, int lddwcf1,
    int lddwcf2, T *dwrf, int lddwrf1, int lddwrf2, T *dwrc, int lddwrc1,
    int lddwrc2, T *dwrcf, int lddwrcf1, int lddwrcf2, int queue_idx) {
...
void gpk_rev_adaptive_launcher(
    ...
    int lddwc2, T *dwr, int lddwr1, int lddwr2, T *dwcf, int lddwcf1,
    int lddwcf2, T *dwrf, int lddwrf1, int lddwrf2, T *dwrc, int lddwrc1,
    int lddwrc2, T *dwrcf, int lddwrcf1, int lddwrcf2, int svr, int svc,
    int svf, int nvr, int nvc, int nvf, int queue_idx) {
