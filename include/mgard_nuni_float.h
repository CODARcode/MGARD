...
namespace mgard_common
{
  ...
  inline float interp_2d(float q11, float q12, float q21, float q22, float x1, float x2, float y1, float y2, float x, float y);

  inline float interp_3d(float q000, float q100, float q110, float q010, float q001, float q101, float q111, float q011, float x1, float x2, float y1, float y2, float z1, float z2, float x, float y, float z);
...
namespace mgard_gen
{
  ...
  void quantize_2D(const int nr, const int nc,  const int nrow, const int ncol, const int nlevel,  float* v, std::vector<int>& work, const std::vector<float>& coords_x, const std::vector<float>& coords_y, float s, float norm, float tol);
    ...
    void dequantize_3D(const int nr, const int nc, const int nf, const int nrow, const int ncol, const int nfib, const int nlevel, float* v, std::vector<int>& out_data , const std::vector<float>& coords_x, const std::vector<float>& coords_y, const std::vector<float>& coords_z);

  void dequantize_3D(const int nr, const int nc, const int nf, const int nrow, const int ncol, const int nfib, const int nlevel, float* v, std::vector<int>& out_data , const std::vector<float>& coords_x, const std::vector<float>& coords_y, const std::vector<float>& coords_z, float s);
  ...
  void dequant_3D(const int nr, const int nc, const int nf, const int nrow, const int ncol, const int nfib, const int nlevel,  const int  l,   float* v, float* work , const std::vector<float>& coords_x, const std::vector<float>& coords_y, const std::vector<float>& coords_z, float s);
  ...
  void refactor_1D ( const int l_target, std::vector<float>& v,  std::vector<float>& work,  std::vector<float>& coords, int n, int no);
...
namespace mgard_gen
{
  inline  float* get_ref(std::vector<float>& v,  const int n, const int no, const int i);
