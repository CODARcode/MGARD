...
class HierarchyCoefficients {
    public:
        ...
        //!Conversion.
        template <typename U>
        operator HierarchyCoefficients<U>() const;
...
class NodalCoefficients: public HierarchyCoefficients<T> {
    public:
        ...
        //!Conversion.
        template <typename U>
        operator NodalCoefficients<U>() const;
};
...
class MultilevelCoefficients: public HierarchyCoefficients<T> {
    public:
        ...
        //!Conversion.
        template <typename U>
        operator MultilevelCoefficients<U>() const;
};
...
class IndicatorCoefficients: public HierarchyCoefficients<T> {
    public:
        ...
        //!Conversion.
        template <typename U>
        operator IndicatorCoefficients<U>() const;
};
