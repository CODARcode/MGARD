...
int main() {
  ...
  mgard_x::compress(3, mgard_x::data_type::Double, shape, tol,
           s, mgard_x::error_bound_type::REL, in_array_cpu,
           compressed_array_cpu, compressed_size, config, false);
  std::cout << "Done\n";

  std::cout << "Decompressing with MGARD-X High level API with Serial backend...";
  // decompression
