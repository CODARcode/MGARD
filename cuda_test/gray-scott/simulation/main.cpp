...
int main(int argc, char **argv)
{
    ...
    for (int i = 0; i < settings.steps;) {
        ...
        // std::string bin_file = "gs_" + std::to_string(sim.L)+"_step_" + std::to_string(i) + "_rank_" + std::to_string(rank)+".dat";
        // std::ofstream wf(bin_file, std::ios::out | std::ios::binary);
        // wf.write((char*)sim.u_noghost().data(), sim.size_z*sim.size_y*sim.size_x * sizeof(double));
        // wf.close();
