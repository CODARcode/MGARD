...
// template tuple3ul HuffmanEncode<uint8__t, uint32_t,
// float>(mgard_cuda_handle<uint8__t> &, string&, uint8__t*, size_t, void * &,
// size_t &, int, int); template tuple3ul HuffmanEncode<uint16_t, uint32_t,
// float>(mgard_cuda_handle<uint16_t> &, string&, uint16_t*, size_t, void * &,
// size_t &, int, int); template tuple3ul HuffmanEncode<uint32_t, uint32_t,
// float>(mgard_cuda_handle<uint32_t> &, string&, uint32_t*, size_t, void * &,
// size_t &, int, int); template tuple3ul HuffmanEncode<uint8__t, uint64_t,
// float>(mgard_cuda_handle<uint8__t> &, string&, uint8__t*, size_t, void * &,
// size_t &, int, int); template tuple3ul HuffmanEncode<uint16_t, uint64_t,
// float>(mgard_cuda_handle<uint16_t> &, string&, uint16_t*, size_t, void * &,
// size_t &, int, int);
...
// template void HuffmanEncode<double, int, uint32_t>(mgard_cuda_handle<double>
// &handle,
...
// template void HuffmanEncode<float, int, uint32_t>(mgard_cuda_handle<float>
// &handle,
//     int* dqv, size_t n, bool * dflags, uint32_t * &dmeta, size_t &dmeta_size,
//     uint32_t * &ddata, size_t &ddata_size, int chunk_size, int dict_size);

// template void HuffmanDecode<float, int, uint32_t>(mgard_cuda_handle<float>
// &handle,
//                           int* &dqv, size_t &n, uint32_t * dmeta, size_t
//                           dmeta_size, uint32_t * ddata, size_t ddata_size);
// template void HuffmanDecode<double, int, uint32_t>(mgard_cuda_handle<double>
// &handle,
//                           int* &dqv, size_t &n, uint32_t * dmeta, size_t
//                           dmeta_size, uint32_t * ddata, size_t ddata_size);
...
#define KERNELS(T, D, S, Q, H)                                                 \
  ...
  template void HuffmanDecode<T, D, S, Q, H>(                                  \
      mgard_cuda_handle<T, D> & handle, S * &dqv, size_t & n, H * dmeta,       \
      size_t dmeta_size, H * ddata, size_t ddata_size);
