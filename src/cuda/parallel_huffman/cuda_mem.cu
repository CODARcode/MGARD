...
template <typename T> inline T *mem::CreateCUDASpace(size_t l, uint8_t i) {
  T *d_var;
...
template int16_t *mem::CreateDeviceSpaceAndMemcpyFromHost(int16_t *var,
                                                          size_t l);
template int32_t *mem::CreateDeviceSpaceAndMemcpyFromHost(int32_t *var,
                                                          size_t l);
template int64_t *mem::CreateDeviceSpaceAndMemcpyFromHost(int64_t *var,
                                                          size_t l);
template uint8_t *mem::CreateDeviceSpaceAndMemcpyFromHost(uint8_t *var,
                                                          size_t l);
template uint16_t *mem::CreateDeviceSpaceAndMemcpyFromHost(uint16_t *var,
                                                           size_t l);
template uint32_t *mem::CreateDeviceSpaceAndMemcpyFromHost(uint32_t *var,
                                                           size_t l);
template uint64_t *mem::CreateDeviceSpaceAndMemcpyFromHost(uint64_t *var,
                                                           size_t l);
...
template int8_t *mem::CreateHostSpaceAndMemcpyFromDevice(int8_t *d_var,
                                                         size_t l);
template int16_t *mem::CreateHostSpaceAndMemcpyFromDevice(int16_t *d_var,
                                                          size_t l);
template int32_t *mem::CreateHostSpaceAndMemcpyFromDevice(int32_t *d_var,
                                                          size_t l);
template int64_t *mem::CreateHostSpaceAndMemcpyFromDevice(int64_t *d_var,
                                                          size_t l);
template uint8_t *mem::CreateHostSpaceAndMemcpyFromDevice(uint8_t *d_var,
                                                          size_t l);
template uint16_t *mem::CreateHostSpaceAndMemcpyFromDevice(uint16_t *d_var,
                                                           size_t l);
template uint32_t *mem::CreateHostSpaceAndMemcpyFromDevice(uint32_t *d_var,
                                                           size_t l);
template uint64_t *mem::CreateHostSpaceAndMemcpyFromDevice(uint64_t *d_var,
                                                           size_t l);
template float *mem::CreateHostSpaceAndMemcpyFromDevice(float *d_var, size_t l);
template double *mem::CreateHostSpaceAndMemcpyFromDevice(double *d_var,
                                                         size_t l);
