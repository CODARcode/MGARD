...
#define KERNELS(T, D_GLOBAL, D_LOCAL, INTERPOLATION, COEFF_RESTORE, TYPE) \
                template void gpk_rev<T, D_GLOBAL, D_LOCAL, INTERPOLATION, COEFF_RESTORE, TYPE>(\
...
KERNELS(double, 1, 1, false, false, 1)
KERNELS(float,  1, 1, false, false, 1)
KERNELS(double, 2, 2, false, false, 1)
KERNELS(float,  2, 2, false, false, 1)
KERNELS(double, 3, 3, false, false, 1)
KERNELS(float,  3, 3, false, false, 1)


KERNELS(double, 4, 3, false, false, 1)
KERNELS(float,  4, 3, false, false, 1)
KERNELS(double, 5, 3, false, false, 1)
KERNELS(float,  5, 3, false, false, 1)

KERNELS(double, 4, 2, false, false, 2)
KERNELS(float,  4, 2, false, false, 2)
KERNELS(double, 5, 2, false, false, 2)
KERNELS(float,  5, 2, false, false, 2)
