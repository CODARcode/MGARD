...
KERNELS(double, 1, 1, true, true, 1)
KERNELS(float,  1, 1, true, true, 1)
KERNELS(double, 2, 2, true, true, 1)
KERNELS(float,  2, 2, true, true, 1)
KERNELS(double, 3, 3, true, true, 1)
KERNELS(float,  3, 3, true, true, 1)
