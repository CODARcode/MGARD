...
void prep_3D_cuda_cpt(mgard_cuda_handle<T> &handle, T *dv, int lddv1,
  ...
  handle.sync_all();
  pi_Ql_first_1(handle, handle.nrow, handle.ncol, handle.nfib, handle.nr,
                handle.nc, handle.nf, handle.dirow, handle.dicol,
                handle.difib_p, handle.ddist_r, handle.ddist_c, handle.ddist_f,
                dv, lddv1, lddv2, 0 % handle.num_of_queues);

  pi_Ql_first_2(handle, handle.nrow, handle.ncol, handle.nfib, handle.nr,
                handle.nc, handle.nf, handle.dirow, handle.dicol_p,
                handle.difib, handle.ddist_r, handle.ddist_c, handle.ddist_f,
                dv, lddv1, lddv2, 1 % handle.num_of_queues);

  pi_Ql_first_3(handle, handle.nrow, handle.ncol, handle.nfib, handle.nr,
                handle.nc, handle.nf, handle.dirow_p, handle.dicol,
                handle.difib, handle.ddist_r, handle.ddist_c, handle.ddist_f,
                dv, lddv1, lddv2, 2 % handle.num_of_queues);

  pi_Ql_first_12(handle, handle.nrow, handle.ncol, handle.nfib, handle.nr,
                 handle.nc, handle.nf, handle.dirow, handle.dicol_p,
                 handle.difib_p, handle.ddist_r, handle.ddist_c, handle.ddist_f,
                 dv, lddv1, lddv2, 3 % handle.num_of_queues);

  pi_Ql_first_13(handle, handle.nrow, handle.ncol, handle.nfib, handle.nr,
                 handle.nc, handle.nf, handle.dirow_p, handle.dicol,
                 handle.difib_p, handle.ddist_r, handle.ddist_c, handle.ddist_f,
                 dv, lddv1, lddv2, 4 % handle.num_of_queues);

  pi_Ql_first_23(handle, handle.nrow, handle.ncol, handle.nfib, handle.nr,
                 handle.nc, handle.nf, handle.dirow_p, handle.dicol_p,
                 handle.difib, handle.ddist_r, handle.ddist_c, handle.ddist_f,
                 dv, lddv1, lddv2, 5 % handle.num_of_queues);

  pi_Ql_first_123(handle, handle.nrow, handle.ncol, handle.nfib, handle.nr,
                  handle.nc, handle.nf, handle.dirow_p, handle.dicol_p,
                  handle.difib_p, handle.ddist_r, handle.ddist_c,
                  handle.ddist_f, dv, lddv1, lddv2, 6 % handle.num_of_queues);
  ...
  add_level(handle, handle.nrow, handle.ncol, handle.nfib, handle.nr, handle.nc,
            handle.nf, 1, 1, 1, handle.dirow, handle.dicol, handle.difib, dv,
            lddv1, lddv2, handle.dwork, handle.lddwork1, handle.lddwork2, 0);
}

template void prep_3D_cuda_cpt<double>(mgard_cuda_handle<double> &handle,
                                       double *dv, int lddv1, int lddv2);
template void prep_3D_cuda_cpt<float>(mgard_cuda_handle<float> &handle,
