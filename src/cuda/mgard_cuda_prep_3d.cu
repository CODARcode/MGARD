...
template <typename T> void 
  prep_3D_cuda_cpt(mgard_cuda_handle<T> & handle, T * dv, int lddv1, int lddv2){
...
template void prep_3D_cuda_cpt<double>(mgard_cuda_handle<double> & handle, double * dv, int lddv1, int lddv2);
template void prep_3D_cuda_cpt<float>(mgard_cuda_handle<float> & handle, float * dv, int lddv1, int lddv2);
