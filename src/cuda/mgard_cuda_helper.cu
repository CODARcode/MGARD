...
template <typename T>
void
cudaMemcpyAsyncHelper(mgard_cuda_handle<T> & handle, void * dst, const void * src, size_t count, enum copy_type kind,
                      int queue_idx){
...
template void
cudaMemcpyAsyncHelper<double>(mgard_cuda_handle<double> & handle, void * dst, const void * src, size_t count, enum copy_type kind,
                              int queue_idx);
template void
cudaMemcpyAsyncHelper<float>(mgard_cuda_handle<float> & handle, void * dst, const void * src, size_t count, enum copy_type kind,
                              int queue_idx);
...
template <typename T>
void 
cudaMemcpy2DAsyncHelper(mgard_cuda_handle<T> & handle,
...
template void 
cudaMemcpy2DAsyncHelper<double>(mgard_cuda_handle<double> & handle,
                                void * dst, size_t dpitch, 
                                void * src, size_t spitch, 
                                size_t width, size_t height,
                                enum copy_type kind,
                                int queue_idx);
template void 
cudaMemcpy2DAsyncHelper<float>(mgard_cuda_handle<float> & handle,
                                void * dst, size_t dpitch, 
                                void * src, size_t spitch, 
                                size_t width, size_t height,
                                enum copy_type kind,
...
template <typename T>
void 
cudaMemcpy3DAsyncHelper(mgard_cuda_handle<T> & handle,
                        void * dst, size_t dpitch, size_t dwidth, size_t dheight,
...
template void 
cudaMemcpy3DAsyncHelper<double>(mgard_cuda_handle<double> & handle,
                        void * dst, size_t dpitch, size_t dwidth, size_t dheight,
                        void * src, size_t spitch, size_t swidth, size_t sheight,
                        size_t width, size_t height, size_t depth,
                        enum copy_type kind,
                        int queue_idx);
template void 
cudaMemcpy3DAsyncHelper<float>(mgard_cuda_handle<float> & handle, 
                        void * dst, size_t dpitch, size_t dwidth, size_t dheight,
                        void * src, size_t spitch, size_t swidth, size_t sheight,
                        size_t width, size_t height, size_t depth,
                        enum copy_type kind,
