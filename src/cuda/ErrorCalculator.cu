...
template float L_inf_error<float>(size_t n, float * original_data, float * decompressed_data, enum error_bound_type mode);
template double L_inf_error<double>(size_t n, double * original_data, double * decompressed_data, enum error_bound_type mode);
template float L_2_error<float>(size_t n, float * original_data, float * decompressed_data, enum error_bound_type mode);
template double L_2_error<double>(size_t n, double * original_data, double * decompressed_data, enum error_bound_type mode);
