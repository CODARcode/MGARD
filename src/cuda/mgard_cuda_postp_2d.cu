...
template <typename T>
void 
postp_2D_cuda(mgard_cuda_handle<T> & handle, T * dv, int lddv) {
...
template void 
postp_2D_cuda<double>(mgard_cuda_handle<double> & handle, double * dv, int lddv);
template void 
postp_2D_cuda<float>(mgard_cuda_handle<float> & handle, float * dv, int lddv);

template <typename T>
void
postp_2D_cuda_cpt(mgard_cuda_handle<T> & handle, T * dv, int lddv) {
...
template void
postp_2D_cuda_cpt<double>(mgard_cuda_handle<double> & handle, double * dv, int lddv);

template void
postp_2D_cuda_cpt<float>(mgard_cuda_handle<float> & handle, float * dv, int lddv);
