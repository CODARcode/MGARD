...
template <typename T>
__global__ void  
_subtract_level_l_cuda(int nrow,       int ncol, int nfib,
...
subtract_level_l_cuda(int nrow,       int ncol, int nfib,
  ...
  _subtract_level_l_cuda<<<blockPerGrid, threadsPerBlock,
...
subtract_level_l_cuda<double>(int nrow,       int ncol, int nfib,
                      int nr,         int nc,         int nf,
                      int row_stride, int col_stride, int fib_stride,
                      int * dirow,    int * dicol, int * difib,
                      ...
                      int queue_idx, bool profile);
template mgard_cuda_ret 
subtract_level_l_cuda<float>(int nrow,       int ncol, int nfib,
                      int nr,         int nc,         int nf,
                      int row_stride, int col_stride, int fib_stride,
                      int * dirow,    int * dicol, int * difib,
...
template <typename T>
__global__ void  
_subtract_level_l_cuda_cpt(int nr,         int nc,         int nf,
                       int row_stride, int col_stride, int fib_stride,
                       T * dv,    int lddv1,      int lddv2,
                       T * dwork, int lddwork1,   int lddwork2) {
...
template <typename T>
mgard_cuda_ret 
subtract_level_l_cuda_cpt(int nr,         int nc,         int nf,
                     int row_stride, int col_stride, int fib_stride,
                     T * dv,    int lddv1,      int lddv2,
                     T * dwork, int lddwork1,   int lddwork2,
                     int B, mgard_cuda_handle & handle, 
  ...
  _subtract_level_l_cuda_cpt<<<blockPerGrid, threadsPerBlock,
                          0, stream>>>(nr,         nc,         nf,
                                       row_stride, col_stride, fib_stride,
                                       dv,         lddv1,      lddv2,
                                       dwork,      lddwork1,   lddwork2);
...
template mgard_cuda_ret 
subtract_level_l_cuda_cpt<double>(int nr,         int nc,         int nf,
                             int row_stride, int col_stride, int fib_stride,
                             double * dv,    int lddv1,      int lddv2,
                             double * dwork, int lddwork1,   int lddwork2,
                             int B, mgard_cuda_handle & handle, 
                             int queue_idx, bool profile);
template mgard_cuda_ret 
subtract_level_l_cuda_cpt<float>(int nr,         int nc,         int nf,
                             int row_stride, int col_stride, int fib_stride,
                             float * dv,    int lddv1,      int lddv2,
                             float * dwork, int lddwork1,   int lddwork2,
                             int B, mgard_cuda_handle & handle, 
