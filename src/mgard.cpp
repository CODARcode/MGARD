...
template
void prep_1D<float>(const int, const int, const int, float *,
                    std::vector<float> &, std::vector<float> &,
                    std::vector<float> &);

template
void prep_1D<double>(const int, const int, const int, double *,
                     std::vector<double> &, std::vector<double> &,
                     std::vector<double> &);

template
void refactor_1D<float>(const int, const int, float *, std::vector<float> &,
                        std::vector<float> &);

template
void refactor_1D<double>(const int, const int, double *, std::vector<double> &,
                         std::vector<double> &);

template
void recompose_1D<float>(const int, const int, const int, float *,
                         std::vector<float> &, std::vector<float> &,
                         std::vector<float> &);

template
void recompose_1D<double>(const int, const int, const int, double *,
                          std::vector<double> &, std::vector<double> &,
                          std::vector<double> &);

template
void postp_1D<float>(const int, const int, const int, float *,
                     std::vector<float> &, std::vector<float> &,
                     std::vector<float> &);

template
void postp_1D<double>(const int, const int, const int, double *,
                      std::vector<double> &, std::vector<double> &,
                      std::vector<double> &);
...
template
unsigned char *refactor_qz_1D<float>(int ncol, const float *u, int &outsize,
                                     float tol);

template
unsigned char *refactor_qz_1D<double>(int ncol, const double *u, int &outsize,
                                      double tol);
...
template
float *recompose_udq_1D<float>(int ncol, unsigned char *data, int data_len);

template
double *recompose_udq_1D<double>(int ncol, unsigned char *data, int data_len);
