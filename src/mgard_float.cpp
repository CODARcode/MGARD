...
template <>
unsigned char *refactor_qz<float>(int nrow, int ncol, int nfib, const float *u,
...
refactor_qz<float>(int nrow, int ncol, int nfib, std::vector<float> &coords_x,
                   ...
                   const float *u, int &outsize, float tol);
...
refactor_qz<float>(int nrow, int ncol, int nfib, std::vector<float> &coords_x,
                   std::vector<float> &coords_y, std::vector<float> &coords_z,
                   const float *u, int &outsize, float tol, float s);

template <>
unsigned char *
refactor_qz<float>(int nrow, int ncol, int nfib, const float *u, int &outsize,
                   float tol, float (*qoi)(int, int, int, std::vector<float>),
                   float s);
...
template <>
unsigned char *refactor_qz_2D<float>(int nrow, int ncol, const float *u,
                                     int &outsize, float tol);
...
template <>
void resample_1d_inv2<float>(const float *inbuf, float *outbuf, const int ncol,
                             const int ncol_new);
