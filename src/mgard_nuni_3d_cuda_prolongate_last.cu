...
template <typename T>
__global__ void 
_prolongate_last_fib(int nrow,        int ncol,         int nfib,
...
template <typename T>
mgard_cuda_ret 
prolongate_last_fib(int nrow,        int ncol,         int nfib,
                  int nr,          int nc,           int nf, 
  ...
  _prolongate_last_fib<<<blockPerGrid, threadsPerBlock, 
...
template <typename T>
__global__ void 
_prolongate_last_col(int nrow,        int ncol,         int nfib,
                   int nr,          int nc,           int nf, 
...
template <typename T>
mgard_cuda_ret 
prolongate_last_col(int nrow,        int ncol,         int nfib,
                  int nr,          int nc,           int nf, 
  ...
  _prolongate_last_col<<<blockPerGrid, threadsPerBlock, 
                             0, stream>>>(nrow,       ncol,       nfib,
                                          nr,         nc,         nf,
                                          dirow,      dicolP,     difib,
                                          dv,         lddv1,      lddv2,
...
template <typename T>
__global__ void 
_prolongate_last_row(int nrow,        int ncol,         int nfib,
                   int nr,          int nc,           int nf, 
...
template <typename T>
mgard_cuda_ret 
prolongate_last_row(int nrow,        int ncol,         int nfib,
                  int nr,          int nc,           int nf, 
  ...
  _prolongate_last_row<<<blockPerGrid, threadsPerBlock, 
                             0, stream>>>(nrow,       ncol,       nfib,
                                          nr,         nc,         nf,
                                          dirowP,     dicol,     difib,
                                          dv,         lddv1,      lddv2,
...
template <typename T>
__global__ void 
_prolongate_last_fib_col(int nrow,        int ncol,         int nfib,
                       int nr,          int nc,           int nf, 
...
template <typename T>
mgard_cuda_ret 
prolongate_last_fib_col(int nrow,        int ncol,         int nfib,
                      int nr,          int nc,           int nf, 
  ...
  _prolongate_last_fib_col<<<blockPerGrid, threadsPerBlock, 
                             0, stream>>>(nrow,       ncol,       nfib,
                                          nr,         nc,         nf,
                                          dirow,      dicolP,      difibP,
                                          dv,         lddv1,      lddv2,
...
template <typename T>
__global__ void 
_prolongate_last_fib_row(int nrow,        int ncol,         int nfib,
                       int nr,          int nc,           int nf, 
...
template <typename T>
mgard_cuda_ret 
prolongate_last_fib_row(int nrow,        int ncol,         int nfib,
                      int nr,          int nc,           int nf, 
  ...
  _prolongate_last_fib_row<<<blockPerGrid, threadsPerBlock, 
                             0, stream>>>(nrow,       ncol,       nfib,
                                          nr,         nc,         nf,
                                          dirowP,     dicol,      difibP,
                                          dv,         lddv1,      lddv2,
...
template <typename T>
__global__ void 
_prolongate_last_col_row(int nrow,        int ncol,         int nfib,
                       int nr,          int nc,           int nf, 
...
template <typename T>
mgard_cuda_ret 
prolongate_last_col_row(int nrow,        int ncol,         int nfib,
                      int nr,          int nc,           int nf, 
  ...
  _prolongate_last_col_row<<<blockPerGrid, threadsPerBlock, 
                             0, stream>>>(nrow,       ncol,       nfib,
                                          nr,         nc,         nf,
                                          dirowP,     dicolP,     difib,
                                          dv,         lddv1,      lddv2,
...
template <typename T>
__global__ void 
_prolongate_last_fib_col_row(int nrow,        int ncol,         int nfib,
                       int nr,          int nc,           int nf, 
...
template <typename T>
mgard_cuda_ret 
prolongate_last_fib_col_row(int nrow,        int ncol,         int nfib,
                      int nr,          int nc,           int nf, 
  ...
  _prolongate_last_fib_col_row<<<blockPerGrid, threadsPerBlock, 
                             0, stream>>>(nrow,       ncol,       nfib,
                                          nr,         nc,         nf,
...
prolongate_last_fib<double>(int nrow,        int ncol,         int nfib,
                          int nr,          int nc,           int nf, 
                          int * dirow,     int * dicol,      int * difibP,
                          ...
                          int queue_idx, bool profile);
template mgard_cuda_ret 
prolongate_last_fib<float>(int nrow,        int ncol,         int nfib,
                         int nr,          int nc,           int nf, 
                         int * dirow,     int * dicol,      int * difibP,
...
template mgard_cuda_ret 
prolongate_last_col<double>(int nrow,        int ncol,         int nfib,
                          int nr,          int nc,           int nf, 
                          int * dirow,     int * dicolP,      int * difib,
                          double * dv,      int lddv1,        int lddv2, 
                          double * ddist_r, double * ddist_c, double * ddist_f,
                          ...
                          int queue_idx, bool profile);
template mgard_cuda_ret 
prolongate_last_col<float>(int nrow,        int ncol,         int nfib,
                         int nr,          int nc,           int nf, 
                         int * dirow,     int * dicolP,      int * difib,
                         float * dv,      int lddv1,        int lddv2, 
                         float * ddist_r, float * ddist_c, float * ddist_f,
                         ...
                         int queue_idx, bool profile);
template mgard_cuda_ret 
prolongate_last_row<double>(int nrow,        int ncol,         int nfib,
                          int nr,          int nc,           int nf, 
                          int * dirowP,     int * dicol,      int * difib,
                          double * dv,      int lddv1,        int lddv2, 
                          double * ddist_r, double * ddist_c, double * ddist_f,
                          ...
                          int queue_idx, bool profile);
template mgard_cuda_ret 
prolongate_last_row<float>(int nrow,        int ncol,         int nfib,
                         int nr,          int nc,           int nf, 
                         int * dirowP,     int * dicol,      int * difib,
                         float * dv,      int lddv1,        int lddv2, 
                         float * ddist_r, float * ddist_c, float * ddist_f,
...
template mgard_cuda_ret 
prolongate_last_fib_col<double>(int nrow,        int ncol,         int nfib,
                          int nr,          int nc,           int nf, 
                          int * dirow,     int * dicolP,      int * difibP,
                          double * dv,      int lddv1,        int lddv2, 
                          double * ddist_r, double * ddist_c, double * ddist_f,
                          ...
                          int queue_idx, bool profile);
template mgard_cuda_ret 
prolongate_last_fib_col<float>(int nrow,        int ncol,         int nfib,
                         int nr,          int nc,           int nf, 
                         int * dirow,     int * dicolP,      int * difibP,
                         float * dv,      int lddv1,        int lddv2, 
                         float * ddist_r, float * ddist_c, float * ddist_f,
                         ...
                         int queue_idx, bool profile);
template mgard_cuda_ret 
prolongate_last_fib_row<double>(int nrow,        int ncol,         int nfib,
                          int nr,          int nc,           int nf, 
                          int * dirowP,    int * dicol,      int * difibP,
                          double * dv,      int lddv1,        int lddv2, 
                          double * ddist_r, double * ddist_c, double * ddist_f,
                          ...
                          int queue_idx, bool profile);
template mgard_cuda_ret 
prolongate_last_fib_row<float>(int nrow,        int ncol,         int nfib,
                         int nr,          int nc,           int nf, 
                         int * dirowP,    int * dicol,      int * difibP,
                         float * dv,      int lddv1,        int lddv2, 
                         float * ddist_r, float * ddist_c, float * ddist_f,
...
template mgard_cuda_ret 
prolongate_last_col_row<double>(int nrow,        int ncol,         int nfib,
                          int nr,          int nc,           int nf, 
                          int * dirowP,    int * dicolP,      int * difib,
                          double * dv,      int lddv1,        int lddv2, 
                          double * ddist_r, double * ddist_c, double * ddist_f,
                          ...
                          int queue_idx, bool profile);
template mgard_cuda_ret 
prolongate_last_col_row<float>(int nrow,        int ncol,         int nfib,
                         int nr,          int nc,           int nf, 
                         int * dirowP,    int * dicolP,      int * difib,
                         float * dv,      int lddv1,        int lddv2, 
                         float * ddist_r, float * ddist_c, float * ddist_f,
                         ...
                         int queue_idx, bool profile);
template mgard_cuda_ret 
prolongate_last_fib_col_row<double>(int nrow,        int ncol,         int nfib,
                          int nr,          int nc,           int nf, 
                          int * dirowP,    int * dicolP,      int * difibP,
                          double * dv,      int lddv1,        int lddv2, 
                          double * ddist_r, double * ddist_c, double * ddist_f,
                          ...
                          int queue_idx, bool profile);
template mgard_cuda_ret 
prolongate_last_fib_col_row<float>(int nrow,        int ncol,         int nfib,
                         int nr,          int nc,           int nf, 
                         int * dirowP,    int * dicolP,      int * difibP,
                         float * dv,      int lddv1,        int lddv2, 
                         float * ddist_r, float * ddist_c, float * ddist_f,
