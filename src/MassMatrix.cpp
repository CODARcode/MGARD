...
SubsetMassMatrix::SubsetMassMatrix(
...
void SubsetMassMatrix::do_operator_parentheses(
...
bool MassMatrix::do_contains(const moab::EntityHandle) const {
    return true;
}

std::size_t ContiguousSubsetMassMatrix::do_index(
